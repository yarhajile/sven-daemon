...
import Adafruit_BBIO.PWM as AdaPWM
...
class PWM(Base):
  ...
  def pwmStart(self):
    ...
    self.polarity = self.start_polarity

    AdaPWM.start(self.address, self.duty, self.start_frequency, self.polarity)
  ...
  def setFrequency(self, frequency):
    AdaPWM.set_frequency(self.address, frequency)


  def setDuty(self, duty):
    AdaPWM.set_duty_cycle(self.address, duty)
